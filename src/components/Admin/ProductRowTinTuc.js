...
import MyLargeModalTinTuc from './MyLargeModalTinTuc';


class ProductRowTinTuc extends Component {
    constructor(props) {
        super(props);
        this.state = {
            show: false,
            ...
            <React.Fragment>
                <tr className="eachRow">
                    ...
                    <td className="del-cell">
                        <MyLargeModalTinTuc getAgainData={this.props.getAgainData} onDeleteClick={this.onDelEvent.bind(this)} product={this.props.product} iddonhang={this.props.product.id} />
                    </td>
                </tr>
            </React.Fragment>
        );
...
export default ProductRowTinTuc;