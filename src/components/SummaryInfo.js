...
class SummaryInfo extends Component {
    constructor(props) {
        super(props);
        this.state = {
            idhoadon: this.props.match.params.id,
            datahoadon: null
        }
    }

    componentWillMount() {
        idhoadonDone = this.props.match.params.id;
        if (this.state.idhoadon === null || this.state.idhoadon === "") {
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xs-12 col-sm-12 col-md-12 mt-30">
                                {this.printDataHinhThucThanhToan()}
