                                                    ...
                                                    if (compareTwoDay(i).getTime() < compareTwoDay(getTodayddmmyyyy()).getTime()) {
                                                        ...
                                                        if (compareTwoDay(i).getTime() === compareTwoDay(daychoosedforloop).getTime()) {
                                                            ...
                                                            if (demvitri === 0) {
                                                                ...
                                                                return (
                                                                    <div key={k} className=" col-md-1-chia7" >
                                                                        <button onClick={(event) => { this.handleClick(event) }} type="button" style={{ "padding": "6px 12px" }} className="btn btn-block btn-info newlinebtn" value={this.state.datasmallestprice1 !== null ? i + " " + this.state.datasmallestprice1 + " VND" : i} >{i}&nbsp;<br /><span style={{ "color": "red", "fontWeight": "bold", "textShadow": "1px 1px 1px black" }}>{this.state.datasmallestprice1 !== null ? this.state.datasmallestprice1 + " VND" : ""}</span></button>
                                                                    </div>
                                                                )
                                                            }
                                                            else if (demvitri === 1) {
                                                                ...
                                                                return (
                                                                    <div key={k} className=" col-md-1-chia7" >
                                                                        <button onClick={(event) => { this.handleClick(event) }} type="button" style={{ "padding": "6px 12px" }} className="btn btn-block btn-info newlinebtn" value={this.state.datasmallestprice2 !== null ? i + " " + this.state.datasmallestprice2 + " VND" : i} >{i}&nbsp;<br /><span style={{ "color": "red", "fontWeight": "bold", "textShadow": "1px 1px 1px black" }}>{this.state.datasmallestprice2 !== null ? this.state.datasmallestprice2 + " VND" : ""}</span></button>
                                                                    </div>
                                                                )
                                                            }
                                                            else if (demvitri === 2) {
                                                                ...
                                                                return (
                                                                    <div key={k} className=" col-md-1-chia7" >
                                                                        <button onClick={(event) => { this.handleClick(event) }} type="button" style={{ "padding": "6px 12px" }} className="btn btn-block btn-info newlinebtn" value={this.state.datasmallestprice3 !== null ? i + " " + this.state.datasmallestprice3 + " VND" : i} >{i}&nbsp;<br /><span style={{ "color": "red", "fontWeight": "bold", "textShadow": "1px 1px 1px black" }}>{this.state.datasmallestprice3 !== null ? this.state.datasmallestprice3 + " VND" : ""}</span></button>
                                                                    </div>
                                                                )
                                                            }
                                                            else if (demvitri === 4) {
                                                                ...
                                                                return (
                                                                    <div key={k} className=" col-md-1-chia7" >
                                                                        <button onClick={(event) => { this.handleClick(event) }} type="button" style={{ "padding": "6px 12px" }} className="btn btn-block btn-info newlinebtn" value={this.state.datasmallestprice4 !== null ? i + " " + this.state.datasmallestprice4 + " VND" : i} >{i}&nbsp;<br /><span style={{ "color": "red", "fontWeight": "bold", "textShadow": "1px 1px 1px black" }}>{this.state.datasmallestprice4 !== null ? this.state.datasmallestprice4 + " VND" : ""}</span></button>
                                                                    </div>
                                                                )
                                                            }
                                                            else if (demvitri === 5) {
                                                                ...
                                                                return (
                                                                    <div key={k} className=" col-md-1-chia7" >
                                                                        <button onClick={(event) => { this.handleClick(event) }} type="button" style={{ "padding": "6px 12px" }} className="btn btn-block btn-info newlinebtn" value={this.state.datasmallestprice5 !== null ? i + " " + this.state.datasmallestprice5 + " VND" : i} >{i}&nbsp;<br /><span style={{ "color": "red", "fontWeight": "bold", "textShadow": "1px 1px 1px black" }}>{this.state.datasmallestprice5 !== null ? this.state.datasmallestprice5 + " VND" : ""}</span></button>
                                                                    </div>
                                                                )
                                                            }
                                                            else if (demvitri === 6) {
                                                                ...
                                                                return (
                                                                    <div key={k} className=" col-md-1-chia7" >
                                                                        <button onClick={(event) => { this.handleClick(event) }} type="button" style={{ "padding": "6px 12px" }} className="btn btn-block btn-info newlinebtn" value={this.state.datasmallestprice6 !== null ? i + " " + this.state.datasmallestprice6 + " VND" : i} >{i}&nbsp;<br /><span style={{ "color": "red", "fontWeight": "bold", "textShadow": "1px 1px 1px black" }}>{this.state.datasmallestprice6 !== null ? this.state.datasmallestprice6 + " VND" : ""}</span></button>
                                                                    </div>
                                                                )
                                                            } else {
                                                                return (
